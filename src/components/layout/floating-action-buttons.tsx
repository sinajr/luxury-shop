      ...
      >
         ...
         <Button
            ...
            className={cn(
                ...
                'transform hover:scale-110 transition-transform duration-150 ease-in-out' // Added hover effect
             )}
        ...
        <Button
          ...
          // disabled={!isScrollToTopVisible} // Can also disable if not visible
        >
